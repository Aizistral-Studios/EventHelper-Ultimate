...
public final class EventUtils {
	...
	public static boolean cantPlace(@Nonnull EntityPlayer player, @Nonnull BlockPos pos, @Nonnull IBlockState blockState) {
		if (isDummyBuild)
			return false;
	...
	public static boolean cantReplace(@Nonnull EntityPlayer player, @Nonnull BlockPos pos, @Nonnull IBlockState blockState) {
		if (isDummyBuild)
			return false;
	...
	public static boolean cantInteract(@Nonnull EntityPlayer player, @Nonnull EnumHand hand, @Nonnull BlockPos targetPos, @Nonnull EnumFacing targetSide) {
		if (isDummyBuild)
			return false;
	...
	public static boolean cantInteract(@Nonnull EntityPlayer player, @Nonnull EnumHand hand, @Nonnull BlockPos interactionPos, @Nonnull BlockPos targetPos, @Nonnull EnumFacing targetSide) {
		if (isDummyBuild)
			return false;
